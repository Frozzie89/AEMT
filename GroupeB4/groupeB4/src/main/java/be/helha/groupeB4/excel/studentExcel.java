...
public class studentExcel {
    ...
    public static void createLearningUnits(XSSFSheet sheet, int sheetSize) {
        ...
        int i = 0;
        CellReference cr;
        Row rowLabel, rowType, rowGrades, rowCredits;
        Cell cellLabel, cellType, cellGrades, cellCredit;
        ...
        while (!cellLabel.toString().equals("%")) {
            ...
            while (cellType != null && !cellType.toString().substring(0, 2).equals("UE")) {
                ...
                for (int j = 1; j < sheetSize; j++) {
                    ...
                    learningActivity = new LearningActivity(idActivity, labelActivity, creditAA, gradeAA);
            ...
            pae.addLearningUnit(learningUnit);
        }
    }
